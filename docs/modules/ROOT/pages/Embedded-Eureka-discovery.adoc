...
image::ROOT:assets/images/eureka.png[]
...
image::ROOT:assets/images/eureka-hazelcast-only.png[]
...
image::ROOT:asserts/images/eureka-hazelcast-separate-client.png[]
...
image::ROOT:assets/images/eureka-hazelcast-metadata.png[]
